...
type AdminArtikelController struct {
	service adminservices.AdminArtikelUseCase
}

func NewAdminArtikelController(service adminservices.AdminArtikelUseCase) *AdminArtikelController {
	return &AdminArtikelController{service: service}
}

func (ac *AdminArtikelController) Create(c *gin.Context) {
...
func (ac *AdminArtikelController) Update(c *gin.Context) {
	id := c.Param("id")
...
func (ac *AdminArtikelController) Delete(c *gin.Context) {
	id := c.Param("id")
	intID, err := strconv.Atoi(id)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": "ID tidak valid"})
...
func (ac *AdminArtikelController) FindAll(c *gin.Context) {
	judul := c.Query("judul")
...
func (ac *AdminArtikelController) GetDetails(c *gin.Context) {
	id := c.Param("id")
	intID, err := strconv.Atoi(id)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": "ID tidak valid"})
